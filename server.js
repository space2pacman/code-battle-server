...
app.post(`/${version}/api/task/check/`, [authenticate, checkAccessLevel(roles.admin)], routes.post.task.check);
app.post(`/${version}/api/task/add/`, [authenticate, checkAccessLevel(roles.admin)], routes.post.task.add);
